...
class AIActivity : AppCompatActivity() {
    ...
    private fun saveTasks() {
        val sharedPreferences = getSharedPreferences("AITasks", Context.MODE_PRIVATE)
        ...
        Log.d("AIActivity", "Saved tasks to SharedPreferences: $jsonString")
    }
    ...
    private fun loadTasks() {
        ...
        try {
            ...
            Log.d("AIActivity", "Loaded tasks from SharedPreferences: $taskList")
        } catch (e: Exception) {
            e.printStackTrace()
            Log.d("AIActivity", "Failed to load tasks: ${e.message}")
            taskList.clear()
        }
    }
    ...
    override fun onPause() {
        super.onPause()
        saveTasks()
        Log.d("AIActivity", "Tasks saved during onPause")
    }

    override fun onDestroy() {
        super.onDestroy()
        saveTasks()
        Log.d("AIActivity", "Tasks saved during onDestroy")
    }
}
